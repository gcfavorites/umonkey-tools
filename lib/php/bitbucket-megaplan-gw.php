 ...
 *
 * Для использования скрипта его нужно положить на какой-нибудь веб-сервер,
 * зайти на страницу администрирования проекта
 * (bitbucket.org/user/repo/admin/services), добавить службу типа POST и
 * указать полный URL скрипта.
 *
