...
- Научиться знакомиться с роботом: если он не в ростере, общение с ним
  невозможно.
...
- Исправить удаление меток: хранить исходную копию, при редактировании
  добавлять удалённые с отрицательным префиксом.
